...
const products = [
  ...
  { id: 3, name: "Chifles Picantes", desc: "Con ají amarillo y un toque de rocoto. 45g.", price: 10.0, img: "chifle_salado.jpeg", cat: "salado", popular: true, size: "12 unid", hasCuts: true },
  ...
  { id: 13, name: "Chifles de Tocino", desc: "Delicioso sabor ahumado a tocino. 45g.", price: 10.0, img: "chifle_salado.jpeg", cat: "salado", popular: false, size: "12 unid", hasCuts: true },
  { id: 14, name: "Chifles al Ajo", desc: "Crujientes chifles con un toque de ajo tostado. 45g.", price: 10.0, img: "chifles de ajo.jpeg", cat: "salado", popular: false, size: "12 unid", hasCuts: true },
  { id: 15, name: "Chifles sabor Ceviche", desc: "El sabor bandera, cítrico y picantito. 45g.", price: 10.0, img: "chifle_salado.jpeg", cat: "salado", popular: true, size: "12 unid", hasCuts: true },
  { id: 16, name: "Chifles Leche de Tigre", desc: "Intenso sabor norteño a leche de tigre. 45g.", price: 10.0, img: "chifles leche de tigre.jpeg", cat: "salado", popular: false, size: "12 unid", hasCuts: true },
  { id: 20, name: "Chifles sabor Pollo a la Brasa", desc: "El irresistible sabor de nuestro plato bandera. 45g.", price: 10.0, img: "chifles pollo a la brasa.jpeg", cat: "salado", popular: true, size: "12 unid", hasCuts: true },
  { id: 21, name: "Chifles 3x10", desc: "¡Súper promoción! Llévate 3 paquetes de nuestros deliciosos chifles.", price: 10.0, img: "chifles 3x10.jpeg", cat: "salado", popular: true, size: "3 unid", hasCuts: true },
  // DULCES
